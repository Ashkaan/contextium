...
# apps/quality/check-commit-subject.sh + apps/quality/check-secrets.sh, which the
...
SUBJECT_CHECK="$REPO_ROOT/apps/quality/check-commit-subject.sh"
SECRET_CHECK="$REPO_ROOT/apps/quality/check-secrets.sh"
