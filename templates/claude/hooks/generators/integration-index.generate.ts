...
// Usage: node .claude/hooks/generators/integration-index.generate.ts [--out /path/to/output.md]
...
function buildReadme(integrations: IntegrationMeta[]): string {
  ...
  return [
    ...
    "",
    "<!-- Generated by .claude/hooks/generators/integration-index.generate.ts — do not edit manually -->",
    "",
